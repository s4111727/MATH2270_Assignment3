...
plot_ly(destinations, x=~Month, y=~Japan_Ratio*100, frame=~Year,
  ...
  layout(showlegend=FALSE,
         title=list(text="Proportion of Outbound Australians Travelling to Japan",
                    y=0.95, yanchor="top"),
         xaxis=list(title=list(text="Month", standoff=10), zeroline=FALSE,
                    automargin=TRUE, categoryorder="array",
                    categoryarray=c("Jan", "Feb", "Mar", "Apr", "May", "Jun",
                                      "Jul", "Aug", "Sep", "Oct", "Nov", "Dec")),
         yaxis=list(title=list(text="Share of Outbound Australians (%)", standoff=5),
                    zeroline=FALSE, automargin=TRUE, range=c(0,10)),
         autosize=TRUE, margin=list(autoexpand=TRUE, l=100, r=100, b=100, t=100)) %>%
...
plot_ly(reasons, x=~Activity, y=~All, type="bar", name="All countries",
  ...
  layout(title=list(text="Participation Rate of Activities by Foreigners in Japan",
         ...
         xaxis=list(title="Activity", tickangle=-35, categoryorder="array",
                    categoryarray=c("Alcohol", "Everyday life", "Exhibit",
                                    "Food", "History/culture", "Hot spring",
                                    "Medical", "Nature sightseeing", "Nature tour",
                                    "Nothing specific", "Other sports",
                                    "Pop-culture tourism", "Pop culture", "Ryokan",
                                    "Seasonal event", "Shopping", "Shopping districts",
                                    "Shows", "Ski/snowboard", "Sports watching",
                                    "Theme parks")),
         autosize=TRUE, margin=list(autoexpand=TRUE, l=100, r=100, b=100, t=100)) %>%
...
plot_ly() %>%
  ...
  layout(title=list(text="Total Cost of a One-Week Family Ski Vacation", 
         ...
         xaxis=list(title="Ski resort", categoryorder="array",
                    categoryarray=c("Falls Creek", "Hakuba")),
